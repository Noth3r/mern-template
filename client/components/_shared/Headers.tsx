...
const Headers = React.forwardRef<HTMLElement, any>((_, ref) => {
	const [isShowing, setIsShowing] = useState(0);

	return (
		<Popover ref={ref} as="header" className="fixed z-50 top-0 w-full bg-white">
			<div className="max-w-7xl mx-auto px-4 sm:px-6">
				<div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
					...
					<Popover.Group as="nav" className="hidden md:flex space-x-10">
						<Popover
							className="relative"
							onMouseEnter={() => setIsShowing(1)}
							onMouseLeave={() => setIsShowing(0)}
						>
							{({ open }) => (
								<>
									<Popover.Button
			...
			>
				<Popover.Panel className="fixed z-50 top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
